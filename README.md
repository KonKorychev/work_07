# Предсказание загруженности метро
Необходимо построить модель, которая прогнозирует загрузку метро на ближайшую неделю, т.е. модель должна предсказывать на 24х7 точек вперёд. Исходные данные об объеме трафика метро с данными о погоде и праздниках на 
